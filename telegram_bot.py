...
# NEW: Ishchilar states
(
    CHOOSE_ISHCHI, ISHCHI_NAME, ISHCHI_SURNAME, ISHCHI_PHONE,
    ISHCHI_PERMISSIONS, ISHCHI_CONFIRM, FIND_ISHCHI, ISHCHI_ACTION,
    ISHCHI_DELETE_CONFIRM, ISHCHI_EDIT_NAME, ISHCHI_EDIT_SURNAME,
    ISHCHI_EDIT_PHONE, ISHCHI_EDIT_PERMISSIONS, ISHCHI_EDIT_CONFIRM
) = range(100, 114)
# NEW: Harajatlar states
(
    HARAJAT_MENU, HARAJAT_TYPE, HARAJAT_AMOUNT, HARAJAT_DATE, HARAJAT_REASON,
    HARAJAT_CONFIRMATION, CHOOSE_ISHCHI_EXPENSE, HARAJAT_LIST, HARAJAT_ACTION,
    HARAJAT_DELETE_CONFIRM, HARAJAT_EDIT_AMOUNT, HARAJAT_EDIT_DATE, HARAJAT_EDIT_REASON,
    HARAJAT_EDIT_ISHCHI, HARAJAT_EDIT_CONFIRM, HARAJAT_EXCEL_MENU,
    HARAJAT_EXCEL_DATE_START, HARAJAT_EXCEL_DATE_END
) = range(200, 218)
# Conversation states
(
    ASK_LOGIN,
    CHOOSE_SUPPLIER, SUPPLIER_NAME, SUPPLIER_PHONE,
    FIND_SUPPLIER, SUPPLIER_ACTION,
    ASK_AMOUNT, ASK_DATE, ASK_REASON, CONFIRMATION,PAYMENT_CURRENCY
) = range(11)
(
    ASK_PAYMENT_AMOUNT, ASK_PAYMENT_DATE, PAYMENT_CONFIRM,ASK_PAYMENT_CURRENCY
) = range(20, 24)
(
    EXCEL_MENU, EXCEL_DATE_START, EXCEL_DATE_END
) = range(30, 33)
(
    REPORT_MENU, REPORT_DATE_START, REPORT_DATE_END
) = range(40, 43)

PAGE_SIZE = 10
REJALA_SUPPLIER_LIST, REJALA_PAYMENT_LIST, REJALA_PAYMENT_ACTION, \
XABAR_PAYMENT_LIST, XABAR_PAYMENT_ACTION, PAYMENT_EDIT_AMOUNT, PAYMENT_EDIT_DATE = range(2000, 2007)
PAGINATION_SIZE = 10
